The code in the repository is a modification of the code given for Hand Signs recognition with Tensorflow. Refer to the instructions below for better understanding. 
